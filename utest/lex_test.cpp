...
BOOST_AUTO_TEST_CASE(lex_test1)
{
    ...
    BOOST_CHECK_EQUAL(tokens[8], NUMBER);
    BOOST_CHECK_EQUAL(tokens[9], ID);
    BOOST_CHECK_EQUAL(tokens[10], ID);
    ...
    BOOST_CHECK_EQUAL(tokens[17], NUMBER);
    BOOST_CHECK_EQUAL(tokens[18], NUMBER);
